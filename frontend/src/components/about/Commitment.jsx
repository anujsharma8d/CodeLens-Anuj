    ...
    return (
        <div className='w-full min-h-screen border-b-4 px-4 sm:px-6 py-16 sm:py-20 md:py-32 flex justify-center items-center'>
            <div className='flex flex-col gap-10'>
                <div>
                    <h1 className="text-4xl font-black uppercase leading-none tracking-tight text-black sm:text-7xl lg:text-8xl text-center sm:text-start ">Built in the open. For everyone.</h1>
                </div>
                <div>
